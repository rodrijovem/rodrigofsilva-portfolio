...
export function getFinvityContent(lang: Lang): ReactNode {
  if (lang === 'en') return (
    <>
      {h("The question the platform has to answer")}
      ...
      {h("One designer, one CEO, three fronts")}
      ...
      {h("Registration became the foundation, and that had a price")}
      ...
      {h("Getting closer to what the specialist already knows")}
      ...
      {h("I prototyped with AI before and after the refactor")}
      ...
      {h("What data modeling taught me")}
  ...
  return (
    <>
      {h("A pergunta que a plataforma precisa responder")}
      ...
      {h("Um designer, um CEO, três frentes")}
      ...
      {h("O cadastro virou a fundação, e isso teve preço")}
      ...
      {h("Aproximar o que o especialista já conhece")}
      ...
      {h("Prototipei com IA antes e depois da refatoração")}
      ...
      {h("O que a modelagem de dados me ensinou")}
...
export function getMiioContent(lang: Lang): ReactNode {
  if (lang === 'en') return (
    <>
      {h("Charging for an app that was free")}
      ...
      {h("Real savings instead of blocked access")}
      ...
      {h("A subscription is not a screen, it's thirteen states")}
      ...
      {h("The connected car became the sales argument")}
      ...
      {h("2,000 subscribers and a 31% faster sign-up")}
      {statsGrid([
  ...
  return (
    <>
      {h("Cobrar por um app que era grátis")}
      ...
      {h("Economia real no lugar de acesso bloqueado")}
      ...
      {h("A assinatura não é uma tela, são treze estados")}
      ...
      {h("O carro conectado virou o argumento de venda")}
      ...
      {h("2.000 assinantes e um cadastro 31% mais rápido")}
      {statsGrid([
...
export function getTembiciContent(lang: Lang): ReactNode {
  if (lang === 'en') return (
    <>
      ...
      {h("What 50 forms and 9 conversations showed")}
      ...
      {h("The workshop that split the fleets")}
      ...
      {h("We validated with Google Forms before writing code")}
      ...
      {h("From the spreadsheet into the app they already used")}
      ...
      {h("What was cut to make the deadline")}
      ...
      {h("R$1M/month and 72% fewer broken bikes")}
      {statsGrid([
      ...
      {h("What I take from this project")}
  ...
  return (
    <>
      ...
      {h("O que 50 formulários e 9 conversas mostraram")}
      ...
      {h("O workshop que separou as frotas")}
      ...
      {h("Validamos com Google Forms antes de escrever código")}
      ...
      {h("Da planilha para dentro do app que eles já usavam")}
      ...
      {h("O que ficou de fora para caber no prazo")}
      ...
      {h("R$1M/mês e 72% menos bicicleta quebrada")}
      {statsGrid([
